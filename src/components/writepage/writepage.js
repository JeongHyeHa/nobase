                    ...
                    <ul>
                        <li>
                            <div className="icon-container">
                                <Link to="/home">
                                    <img src={"./NOBASE_Frontend/image/Home.svg"} alt="홈" />
                                </Link>
                            </div>
                        </li>
                        <li>
                            <div className="icon-container">
                                <Link to="/category">
                                    <img src={"./NOBASE_Frontend/image/Category.svg"} alt="카테고리" />
                                </Link>
                            </div>
                        </li>
                        <li>
                            <div className="icon-container">
                                <Link to="/message">
                                    <img src={"./NOBASE_Frontend/image/Chat.svg"} alt="메세지" />
                                </Link>
                            </div>
                        </li>
                        <li>
                            <div className="icon-container">
                                <Link to="/user">
                                    <img src={"./NOBASE_Frontend/image/User.svg"} alt="사용자 페이지" />
                                </Link>
                            </div>
                        </li>
                    </ul>
